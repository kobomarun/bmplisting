          ...
          <div class="bmp-maincol">
            <div class="row">
              ...
              <div class="col-sm-3 col-xs-12 bmp-home-listing">
                <a href="<?php echo base_url() . "products/details/". $cat->id.'/'.preg_replace('/\s+/', '', $row->name); ?>">
                ...
                <div class="bmp-prod-name"><?php echo $row->name; ?></div>
                <div class="bmp-prod-price">Guide Price: ₦<?php echo $row->price; ?></div>
                <div class="bmp-wishlist-btn-container">
                <a onclick="addProduct(<?php echo $row->id; ?>)">
                  <button class="bmp-wishlist-btn">ADD PRODUCT</button>
                </a>
                </div>
              </div>
              <?php } } ?>
...
<script type="text/javascript">
  function addProduct(product_id)
  {
      $.ajax({  
        type: "POST",  
        url: "<?php echo base_url();?>calculator/add/"+product_id,  
